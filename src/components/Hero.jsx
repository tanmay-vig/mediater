    ...
    return (
        <div className="bg-black text-center pt-5">
            ...
            <div className="text-white fw-bold justify-content-center mx-5">
                ...
                of innovation and creativity. Our platform serves as the
                catalyst for strategic alliances, <br />unlocking endless
                possibilities in the digital landscape. Join the revolution,
                where every collaboration is an opportunity to elevate and
                innovate.
            </div>
        </div>
    );
